/**
 * This is a BLE CTF challenge based on the
 * https://github.com/hackgnar/ble_ctf/tree/master
 */
#include "ctf_ble.h"
#include <esp_mac.h>
#include "esp_bt.h"
...
#define CTF_BLE_TAG "ctf_ble_main"

#define PROFILE_NUM        1
#define PROFILE_APP_IDX    0
#define ESP_APP_ID         0x55
#define SAMPLE_DEVICE_NAME "BSIDES_EC"
...
static const uint8_t char_prop_read_write_indicate =
    ESP_GATT_CHAR_PROP_BIT_WRITE | ESP_GATT_CHAR_PROP_BIT_READ |
...
static char flag_state[20] = {'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F',
                              'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F'};
static uint8_t score_read_value[11] = {'S', 'c', 'o', 'r', 'e', ':',
                                       ' ', '0', '/', '2', '0'};
...
static const char notification_multi_read_value[] =
    "Listen to me for multi notifications";
static const char indicate_multi_read_value[] =
...
// static const uint8_t brute_write_flag[33] = {'B','r','u','t','e','
// ','f','o','r','c','e',' ','m','y',' ','v','a','l','u','e', ' ',
// '0','x','0','0',' ','t','o',' ','0','x','f','f'};
static const uint8_t flag_read_value[16] = {'W', 'r', 'i', 't', 'e', ' ',
                                            'F', 'l', 'a', 'g', 's', ' ',
                                            'H', 'e', 'r', 'e'};
...
static const esp_gatts_attr_db_t gatt_db[HRS_IDX_NB] = {
    ...
    [IDX_CHAR_SCORE] = {{ESP_GATT_AUTO_RSP},
                        {ESP_UUID_LEN_16,
    ...
    [IDX_CHAR_VAL_SCORE] = {{ESP_GATT_AUTO_RSP},
                            {ESP_UUID_LEN_16, (uint8_t*) &GATTS_CHAR_UUID_SCORE,
                             ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
                             GATTS_DEMO_CHAR_VAL_LEN_MAX,
                             sizeof(score_read_value),
                             (uint8_t*) score_read_value}},

    /* FLAG Characteristic Declaration */
    [IDX_CHAR_FLAG] = {{ESP_GATT_AUTO_RSP},
    ...
    [IDX_CHAR_VAL_FLAG] = {{ESP_GATT_AUTO_RSP},
                           {ESP_UUID_LEN_16, (uint8_t*) &GATTS_CHAR_UUID_FLAG,
                            ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
                            GATTS_DEMO_CHAR_VAL_LEN_MAX,
                            sizeof(flag_read_value),
                            (uint8_t*) flag_read_value}},

    /* FLAG MD5 Characteristic Declaration */
    [IDX_CHAR_FLAG_SIMPLE_READ] = {{ESP_GATT_AUTO_RSP},
                                   {ESP_UUID_LEN_16,
                                    (uint8_t*) &character_declaration_uuid,
                                    ESP_GATT_PERM_READ, CHAR_DECLARATION_SIZE,
    ...
    [IDX_CHAR_VAL_FLAG_SIMPLE_READ] =
        {{ESP_GATT_AUTO_RSP},
         {ESP_UUID_LEN_16, (uint8_t*) &GATTS_CHAR_UUID_FLAG_SIMPLE_READ,
          ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX,
          sizeof("d205303e099ceff44835") - 1,
          (uint8_t*) "d205303e099ceff44835"}},

    /* FLAG MD5 Characteristic Declaration */
    [IDX_CHAR_FLAG_MD5] = {{ESP_GATT_AUTO_RSP},
                           {ESP_UUID_LEN_16,
                            (uint8_t*) &character_declaration_uuid,
                            ESP_GATT_PERM_READ, CHAR_DECLARATION_SIZE,
                            CHAR_DECLARATION_SIZE, (uint8_t*) &char_prop_read}},
    ...
    [IDX_CHAR_VAL_FLAG_MD5] =
        {{ESP_GATT_AUTO_RSP},
         {ESP_UUID_LEN_16, (uint8_t*) &GATTS_CHAR_UUID_FLAG_MD5,
          ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX,
          sizeof("MD5 of Device Name") - 1, (uint8_t*) "MD5 of Device Name"}},
    ...
    [IDX_CHAR_VAL_FLAG_WRITE_ANYTHING] =
        {{ESP_GATT_AUTO_RSP},
         {ESP_UUID_LEN_16, (uint8_t*) &GATTS_CHAR_UUID_FLAG_WRITE_ANYTHING,
          ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX,
          sizeof(write_any_flag) - 1, (uint8_t*) write_any_flag}},
    ...
    [IDX_CHAR_VAL_FLAG_WRITE_ASCII] =
        {{ESP_GATT_AUTO_RSP},
         {ESP_UUID_LEN_16, (uint8_t*) &GATTS_CHAR_UUID_FLAG_WRITE_ASCII,
          ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX,
          sizeof(write_ascii_flag) - 1, (uint8_t*) write_ascii_flag}},

    /* FLAG simple write Characteristic Declaration */
    [IDX_CHAR_FLAG_WRITE_HEX] = {{ESP_GATT_AUTO_RSP},
                                 {ESP_UUID_LEN_16,
                                  (uint8_t*) &character_declaration_uuid,
                                  ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
                                  CHAR_DECLARATION_SIZE, CHAR_DECLARATION_SIZE,
    ...
    [IDX_CHAR_VAL_FLAG_WRITE_HEX] =
        {{ESP_GATT_AUTO_RSP},
         {ESP_UUID_LEN_16, (uint8_t*) &GATTS_CHAR_UUID_FLAG_WRITE_HEX,
          ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX,
          sizeof(write_hex_flag) - 1, (uint8_t*) write_hex_flag}},
    ...
    [IDX_CHAR_VAL_FLAG_BRUTE_WRITE] =
        {{ESP_GATT_AUTO_RSP},
         {ESP_UUID_LEN_16, (uint8_t*) &GATTS_CHAR_UUID_FLAG_BRUTE_WRITE,
          ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX,
          sizeof(brute_write_flag) - 1, (uint8_t*) brute_write_flag}},
    ...
    [IDX_CHAR_VAL_FLAG_SIMPLE_WRITE2_READ] =
        {{ESP_GATT_AUTO_RSP},
         {ESP_UUID_LEN_16, (uint8_t*) &GATTS_CHAR_UUID_FLAG_SIMPLE_WRITE2_READ,
          ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX,
          sizeof(read_write2_value), (uint8_t*) read_write2_value}},

    /* FLAG read write Characteristic Declaration */
    [IDX_CHAR_FLAG_SIMPLE_WRITE2] = {{ESP_GATT_AUTO_RSP},
                                     {ESP_UUID_LEN_16,
                                      (uint8_t*) &character_declaration_uuid,
                                      ESP_GATT_PERM_READ, CHAR_DECLARATION_SIZE,
                                      CHAR_DECLARATION_SIZE,
    ...
    [IDX_CHAR_VAL_FLAG_SIMPLE_WRITE2] =
        {{ESP_GATT_AUTO_RSP},
         {ESP_UUID_LEN_16, (uint8_t*) &GATTS_CHAR_UUID_FLAG_SIMPLE_WRITE2,
          ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX,
          sizeof(read_write2_value), (uint8_t*) read_write2_value}},

    /* FLAG read alot Characteristic Declaration */
    [IDX_CHAR_FLAG_READ_ALOT] = {{ESP_GATT_AUTO_RSP},
                                 {ESP_UUID_LEN_16,
                                  (uint8_t*) &character_declaration_uuid,
                                  ESP_GATT_PERM_READ, CHAR_DECLARATION_SIZE,
                                  CHAR_DECLARATION_SIZE,
    ...
    [IDX_CHAR_VAL_FLAG_READ_ALOT] =
        {{ESP_GATT_AUTO_RSP},
         {ESP_UUID_LEN_16, (uint8_t*) &GATTS_CHAR_UUID_FLAG_READ_ALOT,
          ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX,
          sizeof(read_alot_value) - 1, (uint8_t*) read_alot_value}},

    /* Notification flag Characteristic Declaration */
    [IDX_CHAR_FLAG_NOTIFICATION] = {{ESP_GATT_AUTO_RSP},
                                    {ESP_UUID_LEN_16,
                                     (uint8_t*) &character_declaration_uuid,
                                     ESP_GATT_PERM_READ, CHAR_DECLARATION_SIZE,
                                     CHAR_DECLARATION_SIZE,
    ...
    [IDX_CHAR_VAL_FLAG_NOTIFICATION] =
        {{ESP_GATT_AUTO_RSP},
         {ESP_UUID_LEN_16, (uint8_t*) &GATTS_CHAR_UUID_FLAG_NOTIFICATION,
          ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX,
          sizeof(notification_read_value) - 1,
          (uint8_t*) notification_read_value}},
    ...
    [IDX_CHAR_FLAG_INDICATE_READ] = {{ESP_GATT_AUTO_RSP},
                                     {ESP_UUID_LEN_16,
                                      (uint8_t*) &character_declaration_uuid,
                                      ESP_GATT_PERM_READ, CHAR_DECLARATION_SIZE,
                                      CHAR_DECLARATION_SIZE,
    ...
    [IDX_CHAR_VAL_FLAG_INDICATE_READ] =
        {{ESP_GATT_AUTO_RSP},
         {ESP_UUID_LEN_16, (uint8_t*) &GATTS_CHAR_UUID_FLAG_INDICATE_READ,
          ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX,
          sizeof(indicate_read_value) - 1, (uint8_t*) indicate_read_value}},

    /* indicate flag Characteristic Declaration */
    [IDX_CHAR_FLAG_INDICATE] = {{ESP_GATT_AUTO_RSP},
                                {ESP_UUID_LEN_16,
                                 (uint8_t*) &character_declaration_uuid,
                                 ESP_GATT_PERM_READ, CHAR_DECLARATION_SIZE,
                                 CHAR_DECLARATION_SIZE,
    ...
    [IDX_CHAR_VAL_FLAG_INDICATE] =
        {{ESP_GATT_AUTO_RSP},
         {ESP_UUID_LEN_16, (uint8_t*) &GATTS_CHAR_UUID_FLAG_INDICATE,
          ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX,
          sizeof(indicate_read_value), (uint8_t*) indicate_read_value}},
    ...
    [IDX_CHAR_VAL_FLAG_NOTIFICATION_MULTI] =
        {{ESP_GATT_AUTO_RSP},
         {ESP_UUID_LEN_16, (uint8_t*) &GATTS_CHAR_UUID_FLAG_NOTIFICATION_MULTI,
          ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX,
          sizeof(notification_multi_read_value) - 1,
          (uint8_t*) notification_multi_read_value}},
    ...
    [IDX_CHAR_VAL_FLAG_INDICATE_MULTI_READ] =
        {{ESP_GATT_AUTO_RSP},
         {ESP_UUID_LEN_16, (uint8_t*) &GATTS_CHAR_UUID_FLAG_INDICATE_MULTI_READ,
          ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX,
          sizeof(indicate_multi_read_value) - 1,
          (uint8_t*) indicate_multi_read_value}},
    ...
    [IDX_CHAR_VAL_FLAG_INDICATE_MULTI] =
        {{ESP_GATT_AUTO_RSP},
         {ESP_UUID_LEN_16, (uint8_t*) &GATTS_CHAR_UUID_FLAG_INDICATE_MULTI,
          ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX,
          sizeof(indicate_multi_read_value),
          (uint8_t*) indicate_multi_read_value}},
    ...
    [IDX_CHAR_FLAG_MAC] = {{ESP_GATT_AUTO_RSP},
                           {ESP_UUID_LEN_16,
                            (uint8_t*) &character_declaration_uuid,
                            ESP_GATT_PERM_READ, CHAR_DECLARATION_SIZE,
                            CHAR_DECLARATION_SIZE, (uint8_t*) &char_prop_read}},
    ...
    [IDX_CHAR_VAL_FLAG_MAC] =
        {{ESP_GATT_AUTO_RSP},
         {ESP_UUID_LEN_16, (uint8_t*) &GATTS_CHAR_UUID_FLAG_MAC,
          ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, GATTS_DEMO_CHAR_VAL_LEN_MAX,
  ...
  switch (event) {
    ...
    case ESP_GAP_BLE_ADV_START_COMPLETE_EVT:
      ...
      if (param->adv_start_cmpl.status != ESP_BT_STATUS_SUCCESS) {
        ESP_LOGE(CTF_BLE_TAG, "advertising start failed");
      } else {
        ESP_LOGI(CTF_BLE_TAG, "advertising start successfully");
      }
      break;
    case ESP_GAP_BLE_ADV_STOP_COMPLETE_EVT:
      if (param->adv_stop_cmpl.status != ESP_BT_STATUS_SUCCESS) {
        ESP_LOGE(CTF_BLE_TAG, "Advertising stop failed");
      } else {
        ESP_LOGI(CTF_BLE_TAG, "Stop adv successfully\n");
      }
      break;
...
void example_prepare_write_event_env(esp_gatt_if_t gatts_if,
                                     ...
                                     esp_ble_gatts_cb_param_t* param) {
  ESP_LOGI(CTF_BLE_TAG, "prepare write, handle = %d, value len = %d",
  ...
  if (prepare_write_env->prepare_buf == NULL) {
    ...
    if (prepare_write_env->prepare_buf == NULL) {
      ESP_LOGE(CTF_BLE_TAG, "%s, Gatt_server prep no mem", __func__);
  ...
  if (param->write.need_rsp) {
    ...
    if (gatt_rsp != NULL) {
      ...
      if (response_err != ESP_OK) {
        ESP_LOGE(CTF_BLE_TAG, "Send response error");
      }
      free(gatt_rsp);
    } else {
      ESP_LOGE(CTF_BLE_TAG, "%s, malloc failed", __func__);
    }
  }
...
void example_exec_write_event_env(prepare_type_env_t* prepare_write_env,
  ...
  if (param->exec_write.exec_write_flag == ESP_GATT_PREP_WRITE_EXEC &&
      prepare_write_env->prepare_buf) {
    esp_log_buffer_hex(CTF_BLE_TAG, prepare_write_env->prepare_buf,
                       prepare_write_env->prepare_len);
  } else {
    ESP_LOGI(CTF_BLE_TAG, "ESP_GATT_PREP_WRITE_CANCEL");
  }
...
static void gatts_profile_event_handler(esp_gatts_cb_event_t event,
  ...
  switch (event) {
    case ESP_GATTS_REG_EVT: {
      ESP_LOGI(CTF_BLE_TAG, "ESP_GATTS_REG_EVT");
      esp_err_t set_dev_name_ret =
          esp_ble_gap_set_device_name(SAMPLE_DEVICE_NAME);
      if (set_dev_name_ret) {
        ESP_LOGE(CTF_BLE_TAG, "set device name failed, error code = %x",
                 set_dev_name_ret);
      }
#ifdef CONFIG_SET_RAW_ADV_DATA
      ...
      if (raw_adv_ret) {
        ESP_LOGE(CTF_BLE_TAG, "config raw adv data failed, error code = %x ",
                 raw_adv_ret);
      }
      adv_config_done |= ADV_CONFIG_FLAG;
      ...
      if (ret) {
        ESP_LOGE(CTF_BLE_TAG, "config adv data failed, error code = %x", ret);
      }
      adv_config_done |= ADV_CONFIG_FLAG;
      ...
      if (create_attr_ret) {
        ESP_LOGE(CTF_BLE_TAG, "create attr table failed, error code = %x",
                 create_attr_ret);
      }
    } break;
    case ESP_GATTS_READ_EVT:
      ...
      if (read_counter > 1000) {
        esp_ble_gatts_set_attr_value(
            ...
            (uint8_t*) "6ffcd214ffebdc0d069e");
      }
      if (param->read.handle ==
          blectf_handle_table[IDX_CHAR_FLAG_WRITE_RESPONSE] + 1) {
        ...
        if (flag_state[16] == 'T' || flag_state[16] == 'H') {
          ...
          memcpy(rsp->attr_value.value, (uint8_t*) write_response_flag,
                 sizeof(write_response_flag));
        } else {
          rsp->attr_value.len = sizeof(write_response_data);
          rsp->attr_value.auth_req = ESP_GATT_AUTH_REQ_NONE;
          memcpy(rsp->attr_value.value, (uint8_t*) write_response_data,
                 sizeof(write_response_data));
        }
    ...
    case ESP_GATTS_WRITE_EVT:
      ESP_LOGI(CTF_BLE_TAG, "ESP_GATTS_WRITE_EVT");

      if (!param->write.is_prep) {
        ESP_LOGI(CTF_BLE_TAG,
                 "GATT_WRITE_EVT, handle = %d, value len = %d, value :",
                 param->write.handle, param->write.len);
        esp_log_buffer_hex(CTF_BLE_TAG, param->write.value, param->write.len);
        ...
        // any write
        if (blectf_handle_table[IDX_CHAR_FLAG_WRITE_ANYTHING] + 1 ==
            param->write.handle) {
          esp_ble_gatts_set_attr_value(
              blectf_handle_table[IDX_CHAR_FLAG_WRITE_ANYTHING] + 1, 20,
              (uint8_t*) "3873c0270763568cf7aa");
        }

        // hex ascii
        if (blectf_handle_table[IDX_CHAR_FLAG_WRITE_ASCII] + 1 ==
            param->write.handle) {
          if (strcmp(writeData, "yo") == 0) {
            esp_ble_gatts_set_attr_value(
                blectf_handle_table[IDX_CHAR_FLAG_WRITE_ASCII] + 1, 20,
                (uint8_t*) "c55c6314b3db0a6128af");
          } else {
            esp_ble_gatts_set_attr_value(
                blectf_handle_table[IDX_CHAR_FLAG_WRITE_ASCII] + 1,
                sizeof(write_hex_flag) - 1, (uint8_t*) write_ascii_flag);
          }
        }

        // hex write
        if (blectf_handle_table[IDX_CHAR_FLAG_WRITE_HEX] + 1 ==
            param->write.handle) {
          uint16_t descr_value =
              param->write.value[1] << 8 | param->write.value[0];
          if (descr_value == 0x0007) {
            esp_ble_gatts_set_attr_value(
                blectf_handle_table[IDX_CHAR_FLAG_WRITE_HEX] + 1, 20,
                (uint8_t*) "1179080b29f8da16ad66");
          } else {
            esp_ble_gatts_set_attr_value(
                blectf_handle_table[IDX_CHAR_FLAG_WRITE_HEX] + 1,
                sizeof(write_hex_flag) - 1, (uint8_t*) write_hex_flag);
          }
        }
        // brute write
        if (blectf_handle_table[IDX_CHAR_FLAG_BRUTE_WRITE] + 1 ==
            param->write.handle) {
          uint16_t descr_value =
              param->write.value[1] << 8 | param->write.value[0];
          if (descr_value == 0x00D1 || flag_state[8] == 'T' ||
              flag_state[8] == 'H') {
            esp_ble_gatts_set_attr_value(
                blectf_handle_table[IDX_CHAR_FLAG_BRUTE_WRITE] + 1, 20,
                (uint8_t*) "933c1fcfa8ed52d2ec05");
            if (flag_state[8] != 'T') {
              flag_state[8] = 'H';
            }
          } else {
            esp_ble_gatts_set_attr_value(
                blectf_handle_table[IDX_CHAR_FLAG_BRUTE_WRITE] + 1,
                sizeof(brute_write_flag) - 1, (uint8_t*) brute_write_flag);
          }
        }
        // read write
        if (blectf_handle_table[IDX_CHAR_FLAG_SIMPLE_WRITE2] + 1 ==
            param->write.handle) {
          uint16_t descr_value =
              param->write.value[1] << 8 | param->write.value[0];
          if (descr_value == 0x00C9 || flag_state[7] == 'T' ||
              flag_state[7] == 'H') {
            esp_ble_gatts_set_attr_value(
                blectf_handle_table[IDX_CHAR_FLAG_SIMPLE_WRITE2_READ] + 1, 20,
                (uint8_t*) "f8b136d937fad6a2be9f");
            if (flag_state[7] != 'T') {
              flag_state[7] = 'H';
            }
          } else {
            esp_ble_gatts_set_attr_value(
                blectf_handle_table[IDX_CHAR_FLAG_SIMPLE_WRITE2_READ] + 1,
                sizeof read_write2_value, read_write2_value);
          }
        }
        // notify single response flag
        if (blectf_handle_table[IDX_CHAR_FLAG_NOTIFICATION] + 1 ==
            param->write.handle) {
          char notify_data[20] = "5ec3772bcd00cf06d8eb";
          esp_ble_gatts_set_attr_value(
              blectf_handle_table[IDX_CHAR_FLAG_NOTIFICATION] + 1,
              sizeof(notification_read_value) - 1,
              (uint8_t*) notification_read_value);
          esp_ble_gatts_send_indicate(
              gatts_if, param->write.conn_id,
              blectf_handle_table[IDX_CHAR_VAL_FLAG_NOTIFICATION],
              sizeof(notify_data), (uint8_t*) notify_data, false);
        }

        // indicate single response flag flag
        if (blectf_handle_table[IDX_CHAR_FLAG_INDICATE] + 1 ==
            param->write.handle) {
          char indicate_data[20] = "c7b86dd121848c77c113";
          esp_ble_gatts_send_indicate(
              gatts_if, param->write.conn_id,
              blectf_handle_table[IDX_CHAR_VAL_FLAG_INDICATE],
              sizeof(indicate_data), (uint8_t*) indicate_data, true);
        }

        // notify multi response flag
        if (blectf_handle_table[IDX_CHAR_FLAG_NOTIFICATION_MULTI] + 1 ==
            param->write.handle) {
          indicate_handle_state =
              blectf_handle_table[IDX_CHAR_FLAG_NOTIFICATION_MULTI];
          char notify_data[20] = "U no want this msg";
          esp_ble_gatts_set_attr_value(
              blectf_handle_table[IDX_CHAR_FLAG_NOTIFICATION_MULTI] + 1,
              sizeof(notification_multi_read_value) - 1,
              (uint8_t*) notification_multi_read_value);
          esp_ble_gatts_send_indicate(
              gatts_if, param->write.conn_id,
              blectf_handle_table[IDX_CHAR_VAL_FLAG_NOTIFICATION_MULTI],
              sizeof(notify_data), (uint8_t*) notify_data, false);
        }

        // indicate multi response flag flag
        if (blectf_handle_table[IDX_CHAR_FLAG_INDICATE_MULTI] + 1 ==
            param->write.handle) {
          indicate_handle_state =
              blectf_handle_table[IDX_CHAR_FLAG_INDICATE_MULTI];
          char indicate_data[20] = "U no want this msg";
          esp_ble_gatts_send_indicate(
              gatts_if, param->write.conn_id,
              blectf_handle_table[IDX_CHAR_VAL_FLAG_INDICATE_MULTI],
              sizeof(indicate_data), (uint8_t*) indicate_data, true);
        }
        // write response
        //"d41d8cd98f00b204e980"
        if (blectf_handle_table[IDX_CHAR_FLAG_WRITE_RESPONSE] + 1 ==
            param->write.handle) {
        ...
        if (blectf_handle_table[IDX_CHAR_FLAG_HIDDEN_NOTIFY] + 1 ==
            param->write.handle) {
          indicate_handle_state =
              blectf_handle_table[IDX_CHAR_FLAG_HIDDEN_NOTIFY];
          char notify_data[20] = "fc920c68b6006169477b";
          esp_ble_gatts_set_attr_value(
              blectf_handle_table[IDX_CHAR_FLAG_HIDDEN_NOTIFY] + 1,
              sizeof(hidden_notify_value) - 1, (uint8_t*) hidden_notify_value);
          esp_ble_gatts_send_indicate(
              gatts_if, param->write.conn_id,
              blectf_handle_table[IDX_CHAR_VAL_FLAG_HIDDEN_NOTIFY],
              sizeof(notify_data), (uint8_t*) notify_data, false);
        }

        // so many properties
        if (blectf_handle_table[IDX_CHAR_FLAG_CRAZY] + 1 ==
            param->write.handle) {
          esp_ble_gatts_set_attr_value(
              blectf_handle_table[IDX_CHAR_FLAG_CRAZY] + 1, 10,
              (uint8_t*) "fbb966958f");
          char notify_data[10] = "07e4a0cc48";
          esp_ble_gatts_send_indicate(
              gatts_if, param->write.conn_id,
              blectf_handle_table[IDX_CHAR_VAL_FLAG_CRAZY], sizeof(notify_data),
        ...
        if (blectf_handle_table[IDX_CHAR_FLAG] + 1 == param->write.handle) {
          ...
          esp_ble_gatts_set_attr_value(blectf_handle_table[IDX_CHAR_FLAG] + 1,
                                       sizeof flag_read_value, flag_read_value);
          ...
          ESP_LOGI(CTF_BLE_TAG, "FLAG STATE = %s", flag_state);
          set_score();
        }
        /* send response when param->write.need_rsp is true*/
        // if (param->write.need_rsp && send_response == 0){
        if (param->write.need_rsp) {
          ESP_LOGI(CTF_BLE_TAG, "CATCH ALL SEND RESPONSE TRIGGERED");
          esp_ble_gatts_send_response(gatts_if, param->write.conn_id,
                                      param->write.trans_id, ESP_GATT_OK, NULL);
        }
      } else {
        /* handle prepare write */
        ESP_LOGI(CTF_BLE_TAG, "PREPARE WRITE TRIGGERED");
        example_prepare_write_event_env(gatts_if, &prepare_write_env, param);
      }
      break;
    case ESP_GATTS_EXEC_WRITE_EVT:
      ESP_LOGI(CTF_BLE_TAG, "ESP_GATTS_EXEC_WRITE_EVT");
      example_exec_write_event_env(&prepare_write_env, param);
      break;
    case ESP_GATTS_MTU_EVT:
      ESP_LOGI(CTF_BLE_TAG, "ESP_GATTS_MTU_EVT, MTU %d", param->mtu.mtu);
      if (param->mtu.mtu == 444) {
        esp_ble_gatts_set_attr_value(blectf_handle_table[IDX_CHAR_FLAG_MTU] + 1,
                                     20, (uint8_t*) "b1e409e5a4eaf9fe5158");
      }
      break;
    case ESP_GATTS_CONF_EVT:
      ESP_LOGI(CTF_BLE_TAG, "ESP_GATTS_CONF_EVT, status = %d",
               param->conf.status);
      // notify multi
      if (indicate_handle_state ==
          blectf_handle_table[IDX_CHAR_FLAG_NOTIFICATION_MULTI]) {
        ...
        esp_ble_gatts_send_indicate(
            gatts_if, param->write.conn_id,
            blectf_handle_table[IDX_CHAR_VAL_FLAG_NOTIFICATION_MULTI],
            sizeof(indicate_data), (uint8_t*) indicate_data, false);
      }
      // indicate multi
      if (indicate_handle_state ==
          blectf_handle_table[IDX_CHAR_FLAG_INDICATE_MULTI]) {
    ...
    case ESP_GATTS_START_EVT:
      ESP_LOGI(CTF_BLE_TAG, "SERVICE_START_EVT, status %d, service_handle %d",
               param->start.status, param->start.service_handle);
      break;
    case ESP_GATTS_CONNECT_EVT:
      ESP_LOGI(CTF_BLE_TAG, "ESP_GATTS_CONNECT_EVT, conn_id = %d",
               param->connect.conn_id);
      esp_log_buffer_hex(CTF_BLE_TAG, param->connect.remote_bda, 6);
      ...
      if (match_mac[0] == param->connect.remote_bda[0] &&
        ...
        ESP_LOGI(CTF_BLE_TAG, "THIS IS THE MAC YOU ARE LOOKING FOR");
        esp_ble_gatts_set_attr_value(blectf_handle_table[IDX_CHAR_FLAG_MAC] + 1,
                                     20, (uint8_t*) "aca16920583e42bdcf5f");
      }
    ...
    case ESP_GATTS_DISCONNECT_EVT:
      ESP_LOGI(CTF_BLE_TAG, "ESP_GATTS_DISCONNECT_EVT, reason = %d",
    ...
    case ESP_GATTS_CREAT_ATTR_TAB_EVT: {
      if (param->add_attr_tab.status != ESP_GATT_OK) {
        ESP_LOGE(CTF_BLE_TAG, "create attribute table failed, error code=0x%x",
        ...
        memcpy(blectf_handle_table, param->add_attr_tab.handles,
               sizeof(blectf_handle_table));
    ...
    case ESP_GATTS_CLOSE_EVT:
      ESP_LOGI(CTF_BLE_TAG, "ESP_GATTS_CLOSE_EVT");
      break;
    case ESP_GATTS_LISTEN_EVT:
      ESP_LOGI(CTF_BLE_TAG, "ESP_GATTS_LISTEN_EVT");
      break;
    case ESP_GATTS_CONGEST_EVT:
      ESP_LOGI(CTF_BLE_TAG, "ESP_GATTS_CONGEST_EVT");
      break;
    case ESP_GATTS_UNREG_EVT:
      ESP_LOGI(CTF_BLE_TAG, "ESP_GATTS_UNREG_EVT");
      break;
    case ESP_GATTS_DELETE_EVT:
      ESP_LOGI(CTF_BLE_TAG, "ESP_GATTS_DELETE_EVT");
      break;
    case ESP_GATTS_RESPONSE_EVT:
      ESP_LOGI(CTF_BLE_TAG, "ESP_GATTS_RESPONSE_EVT");
      // TODO: change the following to set a read value instead of doing a
      // notify
...
static void gatts_event_handler(esp_gatts_cb_event_t event,
  ...
  if (event == ESP_GATTS_REG_EVT) {
    if (param->reg.status == ESP_GATT_OK) {
      ...
      ESP_LOGE(CTF_BLE_TAG, "reg app failed, app_id %04x, status %d",
  ...
  do {
    ...
    for (idx = 0; idx < PROFILE_NUM; idx++) {
      ...
      if (gatts_if == ESP_GATT_IF_NONE ||
          gatts_if == blectf_profile_tab[idx].gatts_if) {
...
void ctf_ble_module_begin() {
  ...
  if (ret) {
    ESP_LOGE(CTF_BLE_TAG, "%s enable controller failed", __func__);
    return;
  }
  ...
  if (ret) {
    ESP_LOGE(CTF_BLE_TAG, "%s init bluetooth failed", __func__);
    return;
  }

  ret = esp_bluedroid_enable();
  if (ret) {
    ESP_LOGE(CTF_BLE_TAG, "%s enable bluetooth failed", __func__);
    return;
  }

  ret = esp_ble_gatts_register_callback(gatts_event_handler);
  if (ret) {
    ESP_LOGE(CTF_BLE_TAG, "gatts register error, error code = %x", ret);
    return;
  }

  ret = esp_ble_gap_register_callback(gap_event_handler);
  if (ret) {
    ESP_LOGE(CTF_BLE_TAG, "gap register error, error code = %x", ret);
    return;
  }

  ret = esp_ble_gatts_app_register(ESP_APP_ID);
  if (ret) {
    ESP_LOGE(CTF_BLE_TAG, "gatts app register error, error code = %x", ret);
    return;
  }
