...
void wifi_screens_module_animate_attacking(wifi_ap_record_t* ap_record) {
  ...
  oled_screen_display_text_center("Apuntando", 0, OLED_DISPLAY_INVERT);
...
void wifi_screens_module_display_scanned_networks(wifi_ap_record_t* ap_records,
                                                  ...
                                                  int current_option) {
  oled_screen_clear();
  oled_screen_display_text_center("Agarra red", 0, OLED_DISPLAY_NORMAL);
...
void wifi_screens_module_display_attack_selector(char* attack_options[],
                                                 ...
                                                 int current_option) {
  oled_screen_clear();
  oled_screen_display_text_center("Agarra Ataque", 0, OLED_DISPLAY_NORMAL);
